...
async function initUi() {
  try {
    const htmlSuperior = await fetch('horarios_barrasuperior.html').then(r => r.text());
...
function initSidebarNavigation() {
  ...
  const navMap = {
    btnGestion:              'horarios_gestion.html',
    btnProfesores:         'horarios_profesores.html',
    btnUnidades:           'horarios_unidades.html',
    btnMaterias:           'horarios_materias.html',
    btnAulas:              'horarios_aulas.html',
    btnNoDocencia:         'horarios_nodocencia.html'
  };
  ...
  addDropdownListener('btnHorarios', 'horarios_gestion.html'); 
}